...
/**
 * Created by Steve on 07.11.2015.
 */
public class BeatBox {
    ...
    public void buildGUI() {
        ...
        JButton getEmpty = new JButton("Empty");
        getEmpty.addActionListener(new MyEmptyListener());
        buttonBox.add(getEmpty);
    ...
    } // конец метода void buildTrackAndStart
    ...
    public void makeTracks(int[] list) {
        for (int i = 0; i < 16; i++) {
            ...
            if (key != 0) {
                ...
                track.add(makeEvent(128, 99, key, 100, i+1));
            }
        }
    }  // конец метода
